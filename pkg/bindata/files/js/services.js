...
function addServiceCheck()
{
    ...
    const row = '<tr class="services-Checks" id="services-Checks-'+ index +'">'+
        ...
        '<td>'+
        '<select id="Service.'+ index +'.Type" data-app="checks" data-index="'+ index +'" class="client-parameter" data-group="services" data-label="Check '+ instance +' Type" value="http" data-original="" style="width: 100%;">'+
        ...
        '<td><input type="text" id="Service.'+ index +'.Expect" data-app="checks" data-index="'+ index +'" class="client-parameter" data-group="services" data-label="Check '+ instance +' Expect" data-original="" style="width: 100%;"></td>'+
