...
$(document).ready((function() {
    ...
    $('#LogFileSelector').change(function() {
        ...
        $('[id^=fileinfo-], #log-file-actions, #logHelpMsg, #log-file-ajax-error').hide() // hide all other file-info divs, hide actions (until file load completes), hide help msg (this is the active file warning tooltip), hide any error messages.
