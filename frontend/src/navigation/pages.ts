...
import Metrics, { page as MetricsPage } from '../pages/metrics/Index.svelte'
...
import ApiDocs, { page as ApiDocsPage } from '../pages/stubs/ApiDocsLazy.svelte'
...
export const insights: Page[] = [
  ...
  { component: Metrics, ...MetricsPage, path: 'stats' },
