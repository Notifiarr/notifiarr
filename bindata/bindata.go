...
func filesFaviconIco() (*asset, error) {
	...
	info := bindataFileInfo{name: "files/favicon.ico", size: 12206, mode: os.FileMode(420), modTime: time.Unix(1587356420, 0)}
